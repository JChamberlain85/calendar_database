...
--
-- Host: 127.0.0.1    Database: calendar_database
-- ------------------------------------------------------
...
CREATE TABLE `personal_events` (
  ...
  CONSTRAINT `personal_events_ibfk_1` FOREIGN KEY (`Event_ID`) REFERENCES `academic_events` (`Event_ID`) ON DELETE CASCADE
...
-- Dump completed on 2025-12-07 17:54:46
